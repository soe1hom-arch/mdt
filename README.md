...
- Current release: [`v1.0.0`](https://github.com/soe1hom-arch/mdt/releases/tag/v1.0.0)
...
- Linux: `mdt-linux-amd64.tar.gz`, `mdt-linux-arm64.tar.gz`
- macOS: `mdt-darwin-amd64.tar.gz`, `mdt-darwin-arm64.tar.gz`
- Windows: `mdt-windows-amd64.zip`
...
```bash
go install github.com/soe1hom-arch/mdt@latest
```
